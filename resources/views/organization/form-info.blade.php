<fieldset class="mb-3">
    ...
    <x-playground::forms.column column="organization_type" label="Organization Type" :rules="['maxlength' => 255]" />

    @if (!empty($parents))
    <x-playground::forms.column-select column="parent_id" key="label" label="Parent Organization" :records="$parents"/>
    @endif
