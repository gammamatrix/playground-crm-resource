<fieldset class="mb-3">
    ...
    <x-playground::forms.column column="contact_type" label="Contact Type" :rules="['maxlength' => 255]" />

    @if (!empty($parents))
    <x-playground::forms.column-select column="parent_id" key="label" label="Parent Contact" :records="$parents"/>
    @endif
