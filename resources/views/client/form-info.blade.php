<fieldset class="mb-3">
    ...
    <x-playground::forms.column column="client_type" label="Client Type" :rules="['maxlength' => 255]" />

    @if (!empty($parents))
    <x-playground::forms.column-select column="parent_id" key="label" label="Parent Client" :records="$parents"/>
    @endif
