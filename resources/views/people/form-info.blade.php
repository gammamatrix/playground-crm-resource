<fieldset class="mb-3">
    ...
    <x-playground::forms.column column="people_type" label="People Type" :rules="['maxlength' => 255]" />

    @if (!empty($parents))
    <x-playground::forms.column-select column="parent_id" key="label" label="Parent People" :records="$parents"/>
    @endif
