...
/**
 * \Tests\Unit\Playground\Crm\Resource\Http\Requests\People\UnlockRequestTest
 */
class UnlockRequestTest extends RequestTestCase
{
    protected string $requestClass = \Playground\Crm\Resource\Http\Requests\People\UnlockRequest::class;
}
