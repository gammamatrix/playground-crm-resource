...
/**
 * \Tests\Unit\Playground\Crm\Resource\Http\Requests\Organization\EditRequestTest
 */
class EditRequestTest extends RequestTestCase
{
    protected string $requestClass = \Playground\Crm\Resource\Http\Requests\Organization\EditRequest::class;
}
